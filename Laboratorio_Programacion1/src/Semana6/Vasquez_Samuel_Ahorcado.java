...
public class Vasquez_Samuel_Ahorcado extends javax.swing.JFrame {
     ...
     */
    public Vasquez_Samuel_Ahorcado() {
        initComponents();
    }
...
Jugar partida = new Jugar();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Cambiar_Palabra cambio = new Cambiar_Palabra();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vasquez_Samuel_Ahorcado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vasquez_Samuel_Ahorcado().setVisible(true);
            }
        });
    }
